import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineComponent, provide, createElementBlock, h, computed, unref, shallowReactive, Suspense, nextTick, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, markRaw, isShallow, isReactive, toRaw, withCtx, defineAsyncComponent } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_slug_-B54iZWWb.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-B__EyfH2.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B9Z-WXIw.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BGzcFqgJ.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, useHead as c, useRoute as d, entry$1 as default, useSeoMeta as e, useNuxtApp as f, fetchDefaults as g, asyncDataDefaults as h, createError as i, useState as j, nuxtLinkDefaults as n, useRouter as u };
